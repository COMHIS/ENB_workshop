...
harmonize_genres <- function(genres,lang="ENG"){
  ...
  if(lang=="EST"){
    ...
    genres[str_detect(genre,"kroonikad"),relig:="kalend"]
  ...
  if(lang=="ENG")
  {
    ...
    genres[str_detect(genre,"kroonikad"),relig:="calendar"]
    ...
    genres[str_detect(genre,"tants"),tants:="dances"]
    ...
    genres[str_detect(genre,"kataloog"),kataloog:="catalogue"]
  ...
  genres[,genre_standardized:=trimws(str_replace_all(paste(relig,laul,iluk,kalend,haridus,juhend,luule,bürokr,mäng,tants,lastenoorte,näidend,biogr,reis,teatm,teadus,kataloog,toit,sep=" "),"NA",""))][,genre_standardized:=str_replace_all(genre_standardized,"( )+"," ")]
}
